...
public class DemandProvince extends HotbarItemButton {
    private final DemandManager demandManager = ContinentalManagers.demandManager;

    public DemandProvince() {
        super(itemBuilder(Material.IRON_SWORD, Component.text("Demand province", NamedTextColor.AQUA)));
    }
    ...
    public void onRightClickOnBlock(OnUse onUse) {
        ...
        ww2Demands.removeProvinceDemand(province);
    }
