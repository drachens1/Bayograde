...
public enum WarGoalTypeEnum {
    justified(new WarGoalType("justified",new Modifier.create(null).setDisplay(false).addBoost(BoostEnum.stabilityBase,-2f).build(),30,120)),
    partially_justified(new WarGoalType("partially_justified",new Modifier.create(null).setDisplay(false).addBoost(BoostEnum.stabilityBase,-15f).build(),30,85)),
