...
public enum WarGoalTypeEnum {
    ...
    surprise(new WarGoalType("surprise", new Modifier.create(null, "surprise").setDisplay(false).addBoost(BoostEnum.stabilityBase, -55f).addBoost(BoostEnum.relations, -50f).build(), 30, 0));
